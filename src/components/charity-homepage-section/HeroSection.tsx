...
const HeroSection = () => {
	...
	return (
		<section className="relative overflow-hidden max-h-screen h-[1200px] font-exo flex items-center justify-center p-10">
			<AnimatedBlobs count={6} />
			<MotionParticles particleCount={40} connectParticles={true} />
			<div className="flex w-full z-20 max-w-[1500px] ">
				<div className=" h-auto w-1/2 ">
					<div className="flex flex-col items-start h-full gap-10 justify-center px-16 z-20 flex-wrap">
						<motion.span
							initial="hidden"
							animate="visible"
