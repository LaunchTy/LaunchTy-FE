...
interface ProjectProfitCardProps {
	...
	className?: string
	onEdit?: (projectId: string, action: 'withdraw') => void
...
const ProjectProfitCard = ({
	...
	return (
		<section
			ref={sectionRef}
			className={`font-exo relative overflow-hidden min-h-auto ${className}`}
		>
