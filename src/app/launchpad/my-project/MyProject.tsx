            ...
            {hasMore && (
                <div className="align-center flex flex-col justify-center items-center mt-10">
                    <Button
                        ...
                        className="font-bold bg-gradient text-white px-4 sm:px-5 py-2 hover:shadow-[0_0_15px_rgba(192,74,241,0.8),0_0_25px_rgba(39,159,232,0.6)] transition-shadow duration-300 text-sm sm:text-md"
                    >
                        Show more
                    </Button>
                </div>
